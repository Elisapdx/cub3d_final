...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/01 14:11:30 by epraduro          #+#    #+#             */
/*   Updated: 2024/01/01 14:11:38 by epraduro         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
* 1. ce calcul permet de placer chaque colonne de l'ecran dans l'intervalle
-1 à 1. 
* -> qui donc représente la perspective linéaire de gauche à droite.
* 2. ces calculs permette d'ajuster la direction du rayon en fonction de
la postion
